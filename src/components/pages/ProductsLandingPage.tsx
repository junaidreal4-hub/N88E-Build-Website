    ...
    <div className="bg-gradient-to-b from-gray-50 to-white min-h-screen">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-primary mb-6">Our Product Solutions</h1>
          <p className="text-gray-600 max-w-3xl mx-auto">
            Explore our complete range of uPVC solutions engineered for extreme
            climates and modern applications.
          </p>
        </div>
      </section>
            ...
            {products.map((product) => (
              ...
              >
                ...
                <div className="p-12 flex flex-col items-center text-center min-h-[320px] justify-center">
                  ...
                  {/* Tagline */}
                  <p className="text-gray-600 mb-8">{product.tagline}</p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-primary/5">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-primary mb-4">Need Help Choosing?</h2>
          <p className="text-gray-600 mb-6">
            Our experts can help you select the right solution for your specific
            requirements.
          </p>
          <Button
            size="lg"
