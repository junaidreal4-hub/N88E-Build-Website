...
export function PeterPage() {
  ...
  const features = [
    {
      ...
      description:
        "Trapezoidal or corrugated panels with tongue-and-groove or snap-lock joints for quick, tool-free assembly. Ideal for rapid military deployment, enabling quick setup and dismantling in the field.",
    ...
    },
    {
      ...
      description:
        "Foldable or rollable plastic sheets for easy transportation in trucks or backpacks. Functions similarly to foldable solar panels, reducing logistics effort and space usage.",
    ...
    },
    {
      ...
      description:
        "Uses recycled plastic blended with UV stabilizers, fire retardants, and glass fiber for enhanced strength and safety. Includes an inner insulating foam/plastic layer for temperature regulation.",
    ...
    },
    {
      ...
      description:
        "Sheets use camouflage pigments embedded during molding — not surface paint — for UV resistance and military stealth. Optional infrared reflective coating reduces heat absorption.",
      pageRef:
        "Page 3 shows multiple camouflage roof patterns in shades of green and brown.",
    },
    {
      icon: Droplets,
      title: "Built-in Rainwater Harvesting",
      description:
        "Integrated ribs and channels guide rainwater into collection pipes. Perfect for military bases or disaster relief camps needing sustainable water sources.",
      pageRef:
        "Page 3 image depicts ribbed roof panels with built-in drainage paths.",
    },
    {
      icon: Plug,
      title: "Clip-on Add-ons",
      description:
        "Roofing designed with integrated slots for easy attachment of solar film panels (for portable energy), netting or insulation, and ventilation modules.",
      pageRef:
        "Page 4 illustrations show modular slots connecting solar panels, mesh, and vents.",
    },
    {
      icon: Wind,
      title: "Self-cooling / Insulating Design",
      description:
        "Features double-layer, hollow-core sheets that provide thermal insulation, keeping interiors cooler than conventional GI sheets.",
  ...
  const specifications = [
    {
      property: "Material",
      value: "Recycled uPVC with UV stabilizers & fire retardants",
    },
    ...
    { property: "Add-ons", value: "Solar panels, netting, ventilation" },
    {
      ...
      value: "Military, disaster relief, emergency shelters",
    },
  ];
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <Badge
                variant="secondary"
                className="mb-4 bg-green-600 text-white border-none"
              >
                Military & Emergency Solution
              </Badge>

              <div className="flex items-center mb-6">
                <img src={peterLogo} alt="P.E.T.E.R." className="h-32 w-auto" />
              </div>
              ...
              <p className="text-xl text-gray-200 mb-8">
                Revolutionary modular roofing system engineered for rapid
                deployment in military operations, disaster relief, and
                emergency shelter scenarios. Built with recycled materials for
                sustainability without compromising on durability or tactical
                functionality.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                {/* If you have a real PDF, replace this button with an <a href={pdf} download> */}
                <Button
                  size="lg"
                  variant="outline"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg">
              Seven innovative features designed for military and emergency
              applications
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Forward operating bases, field camps, and tactical shelters
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Emergency shelters, medical facilities, and temporary housing
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Research stations, mining camps, and expedition bases
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-gradient-to-br from-gray-900 via-gray-800 to-green-900 text-white py-16">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl mb-4">Ready to Deploy P.E.T.E.R.?</h2>
          <p className="text-xl text-gray-200 mb-8">
            Contact our military solutions team for tactical specifications,
            deployment planning, and custom configuration options.
          </p>
